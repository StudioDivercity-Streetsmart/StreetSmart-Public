...
#"https://api-inference.huggingface.co/models/facebook/mask2former-swin-large-cityscapes-instance"
headers = {
...
if __name__ == "__main__":
    # Update the image path below to point to your local image file.
    ...
    plot_segmentation_map(original_image, segmentation_results, output_path="backend/src/ai/files/out/segmentation_map_new.png")
    print("Done")
